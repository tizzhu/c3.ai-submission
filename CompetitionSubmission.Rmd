...
set.seed(2020.4)
data1 <- read.delim("GSE157103_genes.tpm.tsv",header = TRUE,sep = "\t")
...
GSE157103_calibrated <- geneDESubset['symbol']
for (i in colnames(GSE157103[-1])){
  temp <- 2 ^ ((log2(GSE157103[i]+1) - intercept) / slope) - 1
  GSE157103_calibrated <- cbind(GSE157103_calibrated,temp)
}

write.csv(GSE157103_calibrated,'GSE157103_genes.tpm_calibrated.csv')
```
